...
## Essenz Users
Individuals with the trained ability to apply Essenz beyond basic Enhancement — capable of Transmutation or Force Projection. Rare. Generally wealthy and politically powerful because their abilities create compounding economic advantages. Essenz ability leaves no permanent physical mark on the body and cannot be detected passively. The only visible sign is light emission — a faint to intense luminescence from the body when Essenz is actively stored or channeled. Outside of active use, indistinguishable from anyone else.

Social position varies by region and individual: in powerful states, Essenz Users are typically employed by ruling powers or have become powerful in their own right. Elsewhere: some operate covertly, some serve as warriors and mercenaries, some are integrated into regional structures (guilds, temples, clans). No unified global system exists.
