...
function initialStates(): HassEntities {
  const list: HassEntity[] = [
    ...
    e("automation.jotunland_wallbox_pv_ueberschuss", "on", { friendly_name: "Wallbox: PV-Überschussladen", last_triggered: now() }),
    e("automation.jotunland_heizzeiten", "on", { friendly_name: "Heizung: Heizzeiten", last_triggered: now() }),
    e("automation.jotunland_abwesenheit", "on", { friendly_name: "Heizung: Abwesenheit", last_triggered: null }),
    e("automation.jotunland_fenster_wohnzimmer", "on", { friendly_name: "Fenster offen → Wohnzimmer aus", last_triggered: null }),
    e("automation.jotunland_wallbox_pv_pause", "on", { friendly_name: "Wallbox: Pause bei zu wenig Sonne", last_triggered: null }),
    e("automation.jotunland_pelletvorrat_niedrig", "on", { friendly_name: "Pelletkessel: Vorrat niedrig", last_triggered: null }),
    e("automation.jotunland_pellet_stoerung", "on", { friendly_name: "Pelletkessel: Störung melden", last_triggered: null }),
    e("automation.jotunland_warmwasser_nachheizen", "off", { friendly_name: "Warmwasser: Pellet-Nachheizung", last_triggered: null }),
